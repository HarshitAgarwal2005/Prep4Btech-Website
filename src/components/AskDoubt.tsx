...
import { branches, contentSubjects } from '../data/ECEcontent';
import { branches, contentSubjects } from '../data/MECHcontent';
import { branches, contentSubjects } from '../data/CIVLcontent';
